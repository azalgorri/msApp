            ...
            <div id="datosVendedor_box" class="col-xs-9">
                ...
                <s:form id="newVendedor_form">
                    <div id="datos1_box" class="col-xs-9 blue-text sinpadding">
                        ...
                        <div class="form-group row">
                            <label for="poblacionVen" class="col-xs-3 customLabel">Población</label>
                    ...
                    <div id="datos2_box" class="col-xs-12 blue-text sinpadding">
                        ...
                        <div class="form-group col-xs-6 sinpadding">
                            <label for="tfnVen" class="col-xs-6 customLabel">Teléfono</label>
                        ...
                        <div>
                            <div class="form-group col-xs-6">
                                <label for="codigoVen" class="col-xs-offset-1 col-xs-5 customLabel">Código</label>
                        ...
                        <div>
                            <div class="form-group col-xs-12">
                                <label for="nssVen" class="col-xs-3 customLabel">Nº S.S.</label>
